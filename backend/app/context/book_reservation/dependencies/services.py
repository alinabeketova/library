...
from app.context.book_reservation.services.book_reservation_service import BookReservationService
from app.context.faculty.services.faculty_service import FacultyService



IBookReservationService = Annotated[BookReservationService, Depends()]